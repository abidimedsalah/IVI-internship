/****************************************************************************
** Meta object code from reading C++ file 'Media_bluetooth.h'
**
...
#error "The header file 'Media_bluetooth.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(9, 52, 4), // "etat"
QT_MOC_LITERAL(10, 57, 4), // "call"
QT_MOC_LITERAL(11, 62, 6) // "number"

    },
    "Media\0play\0\0pause\0next\0fastForward\0"
    "prev\0rewind\0prop\0etat\0call\0number"
};
...
void Media::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: { int _r = _t->etat();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 8: { int _r = _t->call((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
